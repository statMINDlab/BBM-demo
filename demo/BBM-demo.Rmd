...
This repository contains the priors for the Yeo17 parcellation.
If you wish to use other parcellations (GICA, MSC, PROFUMO) they can be downloaded from [OSF](https://osf.io/k6vx8/files/osfstorage).
